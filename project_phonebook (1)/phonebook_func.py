...
def first_run(self):
    ...
    with conn:
        ...
        if count < 1:
            cur.execute("""INSERT INTO tbl_phonebook (col_fname,col_lname,col_fullname,col_phone,col_email) VALUES (?,?,?,?,?)""", ('Brandon','Lyon','Brandon Lyon','111-111-1111','lyonbrandonjay!@gmail.com'))
            conn.commit()
    conn.close()
